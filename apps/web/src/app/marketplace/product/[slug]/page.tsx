    ...
    <>
      ...
      <BreadcrumbJsonLd
        items={[
          ...
          ...(product.category
            ? [{ name: product.category.name, url: `https://${siteConfig.domain}/marketplace/category/${product.category.slug}` }]
            : []),
          { name: product.title, url: `https://${siteConfig.domain}/marketplace/product/${product.slug}` },
        ]}
      />
