...
export default function AdminHomePage() {
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-2xl font-bold text-text-default">Admin — Loja</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <a href="/admin/products" className="block p-4 rounded-lg border border-border-default bg-bg-surface hover:border-border-hover transition-colors">
          <h3 className="font-medium text-text-default">Produtos</h3>
          <p className="text-sm text-text-muted mt-1">Gerenciar catálogo</p>
        </a>
        <a href="/admin/categories" className="block p-4 rounded-lg border border-border-default bg-bg-surface hover:border-border-hover transition-colors">
          <h3 className="font-medium text-text-default">Categorias</h3>
          <p className="text-sm text-text-muted mt-1">Organizar produtos</p>
        </a>
        <a href="/admin/quotes" className="block p-4 rounded-lg border border-border-default bg-bg-surface hover:border-border-hover transition-colors">
        ...
        <a href="/admin/orders" className="block p-4 rounded-lg border border-border-default bg-bg-surface hover:border-border-hover transition-colors">
